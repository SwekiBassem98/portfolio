      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-16 text-center space-y-6">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight animate-slide-down">
            {t('authors.meetOurAuthors')}
          </h1>
           <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed animate-slide-up stagger-1">
             {t('authors.authorsDescription')}
           </p>
        </div>
              ...
              <div className="flex items-start gap-6 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-accent font-medium mb-3">{author.role}</p>
                    <p className="text-sm text-muted-foreground">{author.articles} {t('authors.projectsPublished')}</p>
                </div>
              </div>
        ...
        <section className="text-center py-12 rounded-2xl bg-muted">
          <h2 className="text-3xl font-bold mb-4">{t('authors.wantToContribute')}</h2>
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            {t('authors.contributeDescription')}
          </p>
          <a
            href="/contact"
