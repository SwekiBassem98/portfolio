      ...
      <div className="relative aspect-[4/3] overflow-hidden bg-muted rounded-2xl">
        ...
        <div className="absolute inset-0 p-8 flex flex-col justify-between">
          ...
          <div className="flex items-start justify-between">
            <span className={`px-4 py-1.5 rounded-full text-xs font-medium backdrop-blur-md ${getCategoryClass(category)} bg-opacity-80 text-white`}>
              {category}
            </span>
          ...
          <div className="flex items-end justify-between gap-4">
            <div className="flex-1">
              ...
              <h3 className="text-white font-sans font-bold tracking-tight text-xl md:text-2xl lg:text-3xl leading-tight">
                {title}
              </h3>
            </div>
          </div>
